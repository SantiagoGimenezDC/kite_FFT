...
conductivity_dc_mod<T, DIM>::conductivity_dc_mod(system_info<T, DIM>& info, shell_input & vari){
    /* Class constructor
...
template <typename T, unsigned DIM>
bool conductivity_dc_mod<T, DIM>::is_required(){
    ...
    char dirName[] = "/Calculation/conductivity_dc_mod/Direction";
...
template <typename T, unsigned DIM>
void conductivity_dc_mod<T, DIM>::set_default_parameters(){
    ...
    filename            = "condDC_mod.dat";     // Filename to save the final result
...
template <typename T, unsigned DIM>
void conductivity_dc_mod<T, DIM>::set_energy_limits(){
...
template <typename T, unsigned DIM>
bool conductivity_dc_mod<T, DIM>::fetch_parameters(){
	...
	H5::H5File file;
  std::string dirName = "/Calculation/conductivity_dc_mod/";  // location of the information about the conductivity
  ...
  file.close();
	debug_message("Left conductivity_dc_mod::read.\n");
  return possible;
}

template <typename U, unsigned DIM>
void conductivity_dc_mod<U, DIM>::override_parameters(){
...
template <typename U, unsigned DIM>
void conductivity_dc_mod<U, DIM>::printDC(){
    double scale = systemInfo.energy_scale;
    double shift = systemInfo.energy_shift;
...
// Instantiations
template class conductivity_dc_mod<float, 1u>;
template class conductivity_dc_mod<float, 2u>;
template class conductivity_dc_mod<float, 3u>;

template class conductivity_dc_mod<double, 1u>;
template class conductivity_dc_mod<double, 2u>;
template class conductivity_dc_mod<double, 3u>;

template class conductivity_dc_mod<long double, 1u>;
template class conductivity_dc_mod<long double, 2u>;
template class conductivity_dc_mod<long double, 3u>;
