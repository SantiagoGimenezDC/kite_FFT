...
class conductivity_dc_FFT{
    ...
    Eigen::Array<double, -1, -1> integrand_FFT;
    Eigen::Array<double, -1, -1> integrand_FFT_R_data;


    conductivity_dc_FFT(system_info<T, DIM>&, shell_input &);
    void printDC();
