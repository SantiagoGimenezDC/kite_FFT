...
#include "../CondDC/conductivity_dc_FFT.hpp"
#include "../CondDC/conductivity_dc_mod.hpp"
...
void calculate(char *name, shell_input & variables){
  ...
  conductivity_dc_FFT<U, DIM>     condDC_FFT(info, variables);
  conductivity_dc_mod<U, DIM>     condDC_mod(info, variables);  
  verbose_message("------------------------------------------------ \n\n");
