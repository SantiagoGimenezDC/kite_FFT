...
struct GLOBAL_VARIABLES {
  ...
  Eigen::Array <T, Eigen::Dynamic, Eigen::Dynamic> general_gamma_R;
  ...
  Eigen::Array <double, Eigen::Dynamic, Eigen::Dynamic> FFT_cond;
  Eigen::Array <double, Eigen::Dynamic, Eigen::Dynamic> FFT_R_data;  
  ...
  bool calculate_conddc_FFT;
  bool calculate_conddc_mod;    
