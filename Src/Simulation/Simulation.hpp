...
public:
  ...
  void Gamma2D_mod(int,int, int, std::vector<int>,  std::vector<std::vector<unsigned>>, std::string );
  void Gamma2D_FFT(int, int, int, std::vector<int>, int,  std::vector<std::vector<unsigned>>, std::string );  
  ...
  void calc_conddc_mod();
  void CondDC_mod(int, int, int, int, int);
  
  
  void calc_conddc_FFT();
  void CondDC_FFT(int, int, int, int, int, int);
  void store_data_FFT_runtime(Eigen::Matrix<double, -1, 1> *, int,  std::string );
  void store_data_FFT(Eigen::Matrix<double, -1, 1> *, int,  std::string );
